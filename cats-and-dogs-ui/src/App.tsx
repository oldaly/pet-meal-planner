...
export default function App() {
  ...
  const res = await fetch(`https://db4xns85if.execute-api.ap-southeast-2.amazonaws.com/Prod/api/pets?${queryParams.toString()}`);
  ...
  const res = await fetch("https://db4xns85if.execute-api.ap-southeast-2.amazonaws.com/Prod/api/pets", {
    method: "POST",
  ...
  useEffect(() => {
    fetch("https://db4xns85if.execute-api.ap-southeast-2.amazonaws.com/Prod/api/pets")
      .then((res) => res.json())
      .then((data) => {
        setPets(data);
        setLoading(false);
